...
function Vegetarian() {
  ...
  const getVegetarianRecipes = async () => {
    let checkLocalStorage = localStorage.getItem("vegetarianRecipes");
        ...
        <section className="dark:bg-gray-900">
          <div className="px-4 max-w-screen-xl text-center">
            <div role="status">
              ...
              <span className="sr-only">Loading Vegetarian Recipes...</span>
            </div>
          </div>
        </section>
      </div>
  ...
  return (
    <div>
      <div className="max-w-screen-xl mx-auto text-center">
        <h3 className="text-3xl md:text-4xl font-extrabold dark:text-white mb-4 mt-32 text-cyan-600">
          Vegetarian Recipes
        </h3>
      </div>
