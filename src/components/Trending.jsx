...
function Popular() {
        ...
        <section className="dark:bg-gray-900">
          <div className="px-4 max-w-screen-xl text-center">
            <div role="status">
              ...
              <span className="sr-only">Loading Popular Recipes...</span>
            </div>
          </div>
        </section>
      </div>
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center gap-5 px-4" > {/**do not utilize purpose-less divs like this one  */}
      <div >
        <h3 className="text-3xl md:text-4xl font-extrabold dark:text-white mb-4 mt-10 text-cyan-600 ">
          Trending Recipes
        </h3>
      </div>
