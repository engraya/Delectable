...
function LandingPage() {
  ...
  return (
    <div>
    <div className="absolute inset-x-0 -top-40 transform-gpu overflow-hidden blur-3xl sm:-top-80 sm:p-12" aria-hidden="true">
      ...
      <div className="text-center m-6">   
        ...
        <Link to="/trending">
        <button className="px-4 py-4 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-bold rounded-full transition-transform transform-gpu hover:-translate-y-1 hover:shadow-lg">
